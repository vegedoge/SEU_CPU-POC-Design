...
HD_PWD='D:/Vivado/MyProject/POCexp/POCexp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log POCexp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source POCexp.tcl
