...
HD_PWD='D:/Vivado/MyProject/CPU_sim/CPU_sim.runs/rom_cm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_cm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_cm.tcl
